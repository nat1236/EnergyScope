...
if __name__ == '__main__':
    ...
    config = {'case_study': 'this_PV_first', # Name of the case study. The outputs will be printed into : config['ES_path']+'\output_'+config['case_study']
    ...
    alpha = cpt_PV * F_PV.iloc[0,0] - EUD.values - qexp.values
    ...
    # specify the configuration
    config2 = {'case_study': 'this_CCGT_0',# Name of the case study. The outputs will be printed into : config['ES_path']+'\output_'+config['case_study']
          'printing': True,  # printing the data in ETSD_data.dat file for the optimisation problem
    ...
    for i in range(1,2):  #pour l'instant 5 itérations
        ...
        alpha2 = F_CCGT.iloc[0, 0] - EUD2.values - qexp2.values
        ...
        if i % 2 == 0 :  #si itération paire
            config2['case_study'] = 'this_CCGT_' + str(i)
            es.print_data(config2)
            path_dat2 = path / 'case_studies' / config2['case_study']
            ...
            config['case_study'] = 'this_PV_' + str(i)
            es.print_data(config)
            path_dat = path / 'case_studies' / config['case_study']
