...
param q_exp {LAYERS, HOURS, TYPICAL_DAYS} >= 0 default 100000000; #quantity exported to the other country (which is the variable Q_imp of the other)
...
subject to balance_quantities {l in LAYERS, h in HOURS, td in TYPICAL_DAYS} :
	Q_exch[l,h,td] = Q_imp[l,h,td] - q_exp[l,h,td] ;
