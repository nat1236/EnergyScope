...
param q_exch {LAYERS, HOURS, TYPICAL_DAYS} default 0;
...
#var y_bin {LAYERS, HOURS, TYPICAL_DAYS} binary;
...
#subject to binary_qexch {l in LAYERS, h in HOURS, td in TYPICAL_DAYS} :
#	y_bin[l,h,td] = 1 ==> Q_exch[l,h,td] = Q_buy[l,h,td] ;

#subject to binary_qexch2 {l in LAYERS, h in HOURS, td in TYPICAL_DAYS} :
#	y_bin[l,h,td] = 0 ==> Q_exch[l,h,td] = - q_sell[l,h,td] ;
