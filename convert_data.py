...
def generate_resources_csv():
    ...
    resources = resources[['Category', 'Subcategory', 'parameter name', 'avail', 'gwp_op', 'c_op', 'CO2_op']]
    ...
    units = pd.Series(['', '', 'units', '[GWh/y]', '[ktCO2-eq./GWh]', '[Meuro/GWh]', '[ktCO2-eq./GWh]'],
...
def generate_technologies_csv():
    ...
    technologies = technologies[['Category', 'Subcategory', 'Technologies name', 'parameter name', 'c_inv',  'c_maint',
                                 'gwp_constr', 'lifetime', 'c_p', 'fmin_perc', 'fmax_perc', 'f_min', 'f_max']]
